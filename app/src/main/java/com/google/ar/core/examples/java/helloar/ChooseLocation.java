 ...
 */
public class ChooseLocation extends AppCompatActivity implements SampleRender.Renderer {
...
//                        PopupMenu popup = new PopupMenu(ChooseLocation.this, v);
//                        popup.setOnMenuItemClickListener(ChooseLocation.this::settingsMenuClick);
...
//                });
        ...
        forestButton.setOnClickListener(
             ...
             Intent intent = new Intent(getApplicationContext(), ChooseTheme.class);
...
// * plane to place a 3D model.
// */
//public class ChooseLocation extends HelloArActivity {
//
//    @Override
//    protected void onCreate(Bundle savedInstanceState) {
//        super.onCreate(savedInstanceState);
